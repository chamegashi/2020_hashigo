<template>
  <div>
    ...
    <div id="accentUnderBox" class="accentUnderBox">
      <div v-for="(sentence, index) in accent_words" :key="index" class="show-sentence">
...
export default {
  ...
  methods: {
    ...
    moveToButtom () {
      var e = document.getElementById('accentUnderBox')
